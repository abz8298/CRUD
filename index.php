<?php
// INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'buy books', 'please go to buy new books', CURRENT_TIMESTAMP);
$insert = false;
$update = false;
$delete = false;
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="PHP-logo.svg" height="28px" alt="logo"></a>
